...
@section('main')
    ...
    <main class="bg-[#F9FAFB] min-h-[90vh] flex flex-wrap items-center justify-around px-4 py-12 mx-auto">
        ...
        <form action="{{ route('profile.update', auth()->user()->id) }}" method="POST" enctype="multipart/form-data"
            class="bg-white shadow-xl border border-gray-200 rounded-2xl p-8 w-full max-w-2xl space-y-6">
            @csrf
            @method('PUT')

            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-center text-[#5B2AB1]">Perfil</h1>
            ...
            <p id="image_uploaded" class="mx-auto w-fit text-[#5B2AB1] font-semibold hidden">¡Imagen subida!</p>
        ...
        <div class="my-8 flex flex-col items-center max-w-[40vw]">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-center text-[#5B2AB1] w-fit text-center">Direcciones</h2>

            <section class="w-full max-w-6xl mt-12 flex flex-wrap justify-center gap-6">
